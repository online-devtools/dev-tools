          ...
          <div className="space-y-2">
            ...
            <div className="flex gap-3 flex-wrap">
              <button
                ...
                className={`px-4 py-2 rounded-lg font-medium transition-colors ${type === 'paragraphs'
              ...
              <button
                ...
                className={`px-4 py-2 rounded-lg font-medium transition-colors ${type === 'sentences'
                  ? 'bg-blue-500 text-white'
                  : 'bg-gray-200 dark:bg-gray-700 text-gray-800 dark:text-gray-200 hover:bg-gray-300 dark:hover:bg-gray-600'
                  }`}
              >
              ...
              <button
                ...
                className={`px-4 py-2 rounded-lg font-medium transition-colors ${type === 'words'
                  ? 'bg-blue-500 text-white'
                  : 'bg-gray-200 dark:bg-gray-700 text-gray-800 dark:text-gray-200 hover:bg-gray-300 dark:hover:bg-gray-600'
                  }`}
              >
